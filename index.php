    ...
    <div class="navbar navbar-default yamm" role="navigation" id="navbar">
        <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="category.php">Product detail</a>
                                                </li> 
												-->
                                            </ul>
                                        </div>
            ...
            <div class="collapse clearfix" id="search">
                ...
                <form class="navbar-form" role="search" method="post" action="searchresult.php" id="searchText">
			...
			<button href="searchResult.php" type="submit" class="btn btn-primary"  disabled><i class="fa fa-search"></i></button>
		    </span>
                    </div>
                    ...
                    <div class="product-slider">
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="category.php">Fur coat</a></h3>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="category.php">White Blouse Armani</a></h3>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="category.php">Black Blouse Versace</a></h3>
                                    <p class="price">$143.00</p>
                                </div>
                                <!-- /.text -->
                            </div>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="category.php">White Blouse Versace</a></h3>
                                    <p class="price">$143.00</p>
                                </div>
                                <!-- /.text -->
