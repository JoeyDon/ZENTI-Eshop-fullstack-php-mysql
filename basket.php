            ...
            <div class="container">
                ...
                <div class="col-md-9" id="basket">
                    ...
                    <div class="box">
                        ...
                        <form method="post" action="basket.php?action=update" id="cart" >
                            ...
                            <div class="box-footer">
                                ...
                                <div class="pull-right">
									...
									<button type="submit" class="btn btn-info"><i class="fa fa-refresh"></i>Update cart</button>
									
                                    <a class="btn btn-primary" id="beforeCheckout">Proceed to checkout <i class="fa fa-chevron-right"></i>
                                    </a>
                                </div>
                            </div>
				...
				if (isset($cart)) 
				{
					echo '<p hidden id="cartData" value='.$cart.'></p>';
				}
				?>
                </div>
                <!-- /.col-md-9 -->
