...
if (isset($_POST['firstname'])){
	if (empty($_POST['firstname']) || empty($_POST['lastname']) || empty($_POST['address'])|| empty($_POST['postcode'])|| empty($_POST['city']) || empty($_POST['telephone']) || empty($_POST['email']))
	{
		$_SESSION['error_page1'] = "Mandatory field(s) are missing, Please fill it again";
                    ...
                    <div class="box">
                        <form method="post" action="checkout3.php">
							...
							<?php
								...
								echo "<h5 style='color:red'>" . $_SESSION['error_page2'] . "</h5>";
