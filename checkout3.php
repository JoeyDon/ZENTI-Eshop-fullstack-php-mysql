...
{
	$_SESSION['error_page2'] = "Delivery method is unchecked, Please check it again";
        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-9" id="checkout">
                    ...
                    <div class="box">
                        <form method="post" action="checkout4.php" onsubmit="return validateCard()">
							...
							<?php
								...
								echo "<h5 style='color:red'>" . $_SESSION['error_page3'] . "</h5>";
                                    ...
                                    <div class="col-sm-6">
                                        <div class="box payment-method">
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <input type="radio" name="payment" value="payment1" checked="checked" id="payment1">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="box payment-method">
                                            ...
                                            <p>VISA and Mastercard only.</p><p id="errMessage"></p>
											...
											<div class="row">
											  <div class="col-sm-10 form-group">
												<input type="text" name="cardname" placeholder="Name On Card"  class="form-control" id="cardname" onkeyup="validate(this.value,this.id)">
												<span id="cardnameResponse"></span>
											  </div>
											  <div class="col-sm-10 form-group">
												<input type="text" name="cardnumber" placeholder="Card Number" maxlength="16"  class="form-control" id="cardnumber" onkeyup="validate(this.value,this.id)">
												<span id="cardnumberResponse"></span>
											  </div>
											  <div class="col-sm-4 form-group">
												<input type="text" name="expirymonth" placeholder="Expiry Month"  class="form-control" id="expirymonth" onkeyup="validate(this.value,this.id)">
												<span id="expirymonthResponse"></span>
											  </div>
											  <div class="col-sm-4 form-group">
												<input type="text" name="expiryyear" placeholder="Expiry Year"  class="form-control" id="expiryyear" onkeyup="validate(this.value,this.id)">
												<span id="expiryyearResponse"></span>
											  </div>
											  <div class="col-sm-4 form-group">
												<input type="text" name="cvv" placeholder="CVV" maxlength="3"  class="form-control" id="cvv" onkeyup="validate(this.value,this.id)">
												<span id="cvvResponse"></span>
											  </div>
                            ...
                            <div class="box-footer">
                                ...
                                <div class="pull-right">
                                    <button type="submit" class="btn btn-primary" id="btnCheckout3">Continue to Order review<i class="fa fa-chevron-right"></i>
                                    </button>
                                </div>
                            </div>
                        </form>
