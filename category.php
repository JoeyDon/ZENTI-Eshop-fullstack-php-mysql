...
<body>
                                ...
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-sm-6"> <!-- col-sm-3 is changed to col-sm-6 by Shang-->
                                            <h5>Clothing</h5>
                                            <ul>
                                                <li><a onclick="ajaxEntry('MenTshirts')">T-shirts</a>
                                                </li>
                                                <li><a onclick="ajaxEntry('MenShirts')">Shirts</a>
                                                </li>
                                                <li><a onclick="ajaxEntry('MenPants')">Pants</a>
                                                </li>
                                                <li><a onclick="ajaxEntry('MenAccessories')">Accessories</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <!--<div class="col-sm-3">
                                        ...
                                        <div class="col-sm-6"> <!-- col-sm-3 is changed to col-sm-6 by Shang-->
                                            <h5>Accessories</h5>
                                            <ul>
                                                <li><a onclick="ajaxEntry('MenAccessories')">Bags</a>
                                                </li>
                                                <li><a onclick="ajaxEntry('MenAccessories')">Belts</a>
                                                </li>
												<!--
                                                <li><a href="category.php">Hiking shoes</a>
                                                </li>
                                ...
                                <div class="yamm-content">
                                    <div class="row">
                                        <div class="col-sm-6"> <!-- col-sm-3 is changed to col-sm-6 by Shang-->
                                            <h5>Clothing</h5>
                                            <ul>
                                                <li><a onclick="ajaxEntry('LadiesTshirts')">T-shirts</a>
                                                </li>
                                                <li><a onclick="ajaxEntry('LadiesShirts')">Shirts</a>
                                                </li>
                                                <li><a onclick="ajaxEntry('LadiesPants')">Pants</a>
                                                </li>
                                                <li><a onclick="ajaxEntry('LadiesAccessories')">Accessories</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <!-- <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-6"> <!-- col-sm-3 is changed to col-sm-6 by Shang-->
                                            <h5>Accessories</h5>
                                            <ul>
                                                <li><a onclick="ajaxEntry('LadiesAccessories')">Bags</a>
                                                </li>
                                                <li><a onclick="ajaxEntry('LadiesAccessories')">Belts</a>
                                                </li>
												<!--
                                                <li><a href="category.php">Hiking shoes</a>
                                                </li>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            ...
                                            <ul>
                                                ...
                                                <li><a onclick="ajaxEntry('Men')">Category - men</a>
                                                </li>
												<li><a onclick="ajaxEntry('Ladies')">Category - ladies</a>
                                                </li>                                                 
                                                <!--
            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li><div class="genderNav"  >Ladies</div></li>
                    </ul>
                </div>
 ...
 _________________________________________________________ -->
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                <li id="MenCatogory">
                                    <a onclick="ajaxEntry('Men')">Men <span class="badge pull-right">14</span></a>
                                    <ul>
                                        <li><a onclick="ajaxEntry('MenTshirts')">T-shirts</a>
										</li>
										<li><a onclick="ajaxEntry('MenShirts')">Shirts</a>
                                ...
                                <li id="LadiesCatogory">
                                    <a onclick="ajaxEntry('Ladies')">Ladies  <span class="badge pull-right">14</span></a>
                                    <ul>
                                        <li><a onclick="ajaxEntry('LadiesTshirts')">T-shirts</a>
										</li>
										<li><a onclick="ajaxEntry('LadiesShirts')">Shirts</a>
                    ...
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            ...
                            <form>
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label><input type="checkbox" class="ArmaniFilter">
										Armani</label>&nbsp;
										<div class="ArmaniNum">(0)</div>
                                        
                                    </div>
                                    <div class="checkbox">
                                        <label><input type="checkbox" class="VersaceFilter">
										Versace</label>&nbsp; <div class="VersaceNum">(0)</div>
                                        
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" class="CarloBruniFilter">Carlo Bruni</label>&nbsp;<div class="CarloBruniNum">(0)</div>
                                        
                                    </div>
                                    <div class="checkbox">
                                        <label><input type="checkbox" class="JackHoneyFilter">
										Jack Honey</label>&nbsp; 
										<div class="JackHoneyNum">(0)</div>
                ...
                <div class="col-md-9">
                    <div class="box" id="productPageIntro">
                        <h1>Ladies</h1>
                    ...
                    <div class="box info-bar">
                        <div class="row">
                            <div class="col-sm-12 col-md-4 products-showing">
                                Showing <strong class="currentDisplayingNum">6</strong> of <strong class="allProductsNum">12</strong> products
                            </div>
                                    ...
                                    <form class="form-inline">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="products-sort-by">
                                                ...
                                                <select name="sort-by" class="form-control" id="sortDropList">
                    ...
                    <div class="row products" id="productsRow">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        ...
                        <ul>
                            <li><a href="category-man-T-shirts.html">T-shirts</a>
                            </li>
                            <li><a href="category.php">Shirts</a>
                            </li>
							<li><a href="category.php">Pants</a>
