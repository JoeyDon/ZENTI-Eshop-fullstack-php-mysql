        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-12">
                    <div class="box">
						<?php
						$password = $_POST["passwordForLogging"];
						$email = $_POST["emailForLoging"];
						...
						if ($result->num_rows > 0) {
							while($row = $result->fetch_assoc()){
								if($password == $row["password"])
								{
									...
									echo "<h3 style='color:red'>Login Successed,Welcome back! ".$cookie_value ."</h3>";
								}
							}
						}
						...
						while(oci_fetch_array($stmt)) {
							if(oci_result($stmt,"PASSWORD") == $password)
							{
								$loginSucceed = 1;
								$cookie_name = "logged";
								$cookie_value = oci_result($stmt,"USERNAME");
