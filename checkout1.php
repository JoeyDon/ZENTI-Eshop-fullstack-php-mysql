...
<body>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="customer-orders.php" method="post">
                            ...
                            <p class="text-center">
                                <button class="btn btn-primary" id="btnInCheckout1"><i class="fa fa-sign-in"></i> Log in</button>
                            </p>
					...
					?>
                        <form method="post" action="checkout2.php">
                            ...
                            <div class="content">
								...
								<p class="from-group text-muted">* If you set up personal information in account page before, it will fill here automatically.</p>
								<p class="from-group text-muted">* If you haven't, we recommond you do that first(by click top-right corner your name).</p>
								<?php
									 if (!empty($_SESSION['error_page1'])) {
									 echo "<h5 style='color:red'>" . $_SESSION['error_page1'] . "</h5>";
									 unset($_SESSION['error_page1']);
								 }?>
                                ...
                                <div class="row">									
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="firstname" name="firstname" onkeyup="validate(this.value,this.id)" value="<?php
										...
										?>">
											<span id="firstnameResponse"></span>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="lastname">Lastname *</label><span id="lastnameResponse"></span>
                                            <input type="text" class="form-control" id="lastname" name="lastname" onkeyup="validate(this.value,this.id)" value="<?php
											$sql = "SELECT * FROM members where username = '${name}'";
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="address">Address *</label><span id="addressResponse"></span>
                                            <input type="text" class="form-control" id="address" name="address" onkeyup="validate(this.value,this.id)" value="<?php
											$sql = "SELECT * FROM members where username = '${name}'";
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-md-3">
                                        <div class="form-group">
                                            <label for="city">City *</label><span id="cityResponse"></span>
                                            <input type="text" class="form-control" id="city" name="city" onkeyup="validate(this.value,this.id)" value="<?php
											$sql = "SELECT * FROM members where username = '${name}'";
                                    ...
                                    <div class="col-sm-6 col-md-3">
                                        <div class="form-group">
                                            <label for="postcode">Postcode *</label><span id="postcodeResponse"></span>
                                            <input type="text" class="form-control" id="postcode" name="postcode" onkeyup="validate(this.value,this.id)" value="<?php
											$sql = "SELECT * FROM members where username = '${name}'";
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="phone">Telephone *</label><span id="phoneResponse"></span>
                                            <input type="text" class="form-control" id="telephone" name="telephone" onkeyup="validate(this.value,this.id)" value="<?php
											$sql = "SELECT * FROM members where username = '${name}'";
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="email">Email *</label><span id="emailResponse"></span>
                                            <input type="text" class="form-control" id="email" name="email" onkeyup="validate(this.value,this.id)" value="<?php
											$sql = "SELECT * FROM members where username = '${name}'";
                            ...
                            <div class="box-footer">
                                ...
                                <div class="pull-right">
                                    <button type="submit" class="btn btn-primary" id="btnCheckout1">Continue to Delivery Method<i class="fa fa-chevron-right"></i>
                                    </button>
                                </div>
                            </div>
                        </form>
                            ...
                            <table class="table">
								<tbody>
                                    <tr>
                                        ...
                                        <th>$<?php echo $_SESSION['totalPrice']?>.00</th>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <th>$<?php echo ($_SESSION['totalPrice']/10)?>.00</th>
                                    </tr>
                                    <tr class="total">
                                        <td>Total</td>
                                        <th>$<?php echo ($_SESSION['totalPrice']+10)?>.00</th>
 ...
 _________________________________________________________ -->
        <div id="copyright">
            <div class="container">
                <div class="col-md-6">
                    <p class="pull-left">© 2017 ZenTi Ltd.</p>
