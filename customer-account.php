                    ...
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li>
                                    <a href="index.php" id="accPageLogout"><i class="fa fa-sign-out"></i> Logout</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <form method="post" action="?">
							<?php
								...
								if(isset($_POST['oldPassword']))
								{
									...
									$passwordWrongFromDb = 0;
									/* Change password */
									if( $newPassword == $confirmPassword)
									{
										
										$sql  = "SELECT * FROM members where username like '%".$name."%'";
									...
									{
										echo "<h3 style='color:red'>Failed in changing passwords, Two passwords you just typred are different.</h3>";
									}
									
									if($passwordWrongFromDb==1)
									{
										echo "<h3 style='color:red'>Failed in changing passwords due to wrong old password.</h3>";
									}
                        ...
                        <form method="post" action="?">
							<?php
								...
								if(isset($_POST['firstname']))
								{
									...
									echo "<br/><br/><strong>current user:(for developing testing)</strong><table border='1'>
									<tr>
									<th>username</th>
									<th>firstname</th>
									<th>lastname</th>
