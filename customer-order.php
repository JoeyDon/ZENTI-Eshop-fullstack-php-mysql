<?php
	...
	while(oci_fetch_array($stmt)) {
		...
		$date = oci_result($stmt,"DATEB");
		$cart = oci_result($stmt,"CART");
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-9" id="customer-order">
                    <div class="box">
                        ...
                        <p class="lead">Order #<?php echo $orderid;?> was placed on <strong><?php echo $date;?></strong> and is currently <strong>Being prepared</strong>.</p>
