...
$productTitle = $productPrice = $productDetails = $productMaterial = $productSize = "";
...
foreach($xml->children() as $products) {
	if($products->id == $q)
	{
		...
		$productDetails = $products->style->description;
		$productMaterial = $products->style->details->material;
		$productSize = $products->style->details->size;
		
		$productImage1 = $products->img;
		$productImage2 = $products->img2;
	}
} 
?>
<!DOCTYPE html>
                    ...
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                <li>
                                    <a href="category.php">Men <span class="badge pull-right">12</span></a>
                                    <ul>
                                        <li><a href="category.php">T-shirts</a>
                                        </li>
                                        <li><a href="category.php">Shirts</a>
                                ...
                                <li>
                                    <a href="category.php">Ladies  <span class="badge pull-right">12</span></a>
                                    <ul>
                                        <li><a href="category.php">T-shirts</a>
                                        </li>
                                        <li><a href="category.php">Shirts</a>
                ...
                <div class="col-md-9">
                    ...
                    <div class="row" id="productMain">
                        <div class="col-sm-6">
                            <div id="mainImage">
								<?php
									echo "<img src=\"".$productImage1 ."\" alt=\"\" class=\"img-responsive\">";
								?>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="box">
                                ...
                                <p class="text-center buttons">
                                    <a href="basket.php?action=add&id=<?php echo $q;?>" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> Add to cart</a> 
									<!--
                    ...
                    <div class="box" id="details">
                        <p>
                            ...
                            <h4>Material & care</h4>
                            <ul>
                                <li><?php echo $productMaterial ; ?></li>
                            </ul>
                            <h4>Size & Fit</h4>
                            <ul>
                                <li><?php echo $productSize; ?></li>
