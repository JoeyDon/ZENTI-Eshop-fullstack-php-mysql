                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
								...
								<?php
									...
									$dbuser = "zhiyi"; /* your deakin login */
									$dbpass = "Ninispose1"; /* your oracle access password */
									$db = "SSID";
									...
									$query =  "SELECT * FROM orders where username like '%".$_COOKIE['logged']."%'";
									...
									while(oci_fetch_array($stmt)) {
									  echo "<tr>";
									  echo "<th># &nbsp;" . oci_result($stmt,"ORDERID") . "</th>";
									  echo "<td>" . oci_result($stmt,"DATEB") . "</td>";
									  echo "<td>$" . oci_result($stmt,"TOTAL") . ".00</td>";
									  echo "<td><span class='label label-info'>Being prepared</span>
                                        </td>";
									  echo "<td><a href='customer-order.php?q=".oci_result($stmt,"ORDERID")."' class='btn btn-primary btn-sm'>View</a>
                                        </td>";
									  }
