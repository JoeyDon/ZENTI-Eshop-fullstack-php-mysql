            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li><div class="genderNav"  >Search Results</div></li>
                    </ul>
                </div>
 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-12">
                    <div class="box" id="productPageIntro">
                        <h1>We found as you searched</h1>
                    </div>
                    ...
                    <div class="row products" id="productsRow">
						...
						if (!$connect) {
							echo "error, couldn't connect to ssid database.";
							exit;
						}
						
						$sql= "SELECT TITLE From products where id = 1";
						//parse sql statement
						...
						//execuate sql statement
						oci_execute($stmt);
						while (oci_fetch($stmt)) {
							echo oci_result($stmt, "TITLE");
						}
